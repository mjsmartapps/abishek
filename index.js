    ...
    if (loginModalContainer) {
        loginModalContainer.querySelector('.modal-content').innerHTML = `
            ...
            <form id="phone-login-form" style="margin-bottom: 0; box-shadow: none; border: none; padding: 0;">
                ...
                <div class="form-group" style="margin-top: 10px; display: flex; align-items: flex-start; gap: 8px;">
                    <input type="checkbox" id="tnc-checkbox" required style="margin-top: 2px;">
                    <label for="tnc-checkbox" style="font-size: 11px; font-weight: normal; color: #546e7a; margin: 0; line-height: 1.4;">
                        I agree to the <a href="#" onclick="document.getElementById('tnc-modal').style.display='flex'; return false;" style="color: var(--primary-color); text-decoration: underline;">Terms & Conditions</a> and <a href="#" onclick="document.getElementById('tnc-modal').style.display='flex'; return false;" style="color: var(--primary-color); text-decoration: underline;">Data Privacy Policy</a>.
                    </label>
                </div>
